...
sum_three = sum(range_three)
sum_five = sum(range_five)
...
sum_fifteen = sum(range_fifteen)

# Adds the above variables together.
three_and_five_sum = sum_three + sum_five
# Subtracts sum of multiples of fifteen as earlier.
total_sum = three_and_five_sum - sum_fifteen
